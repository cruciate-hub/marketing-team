...
- Total word count matches the per-type band in `references/structure-template.md` §"Length targets by release type" (the single source of truth — e.g. product launch 500–800, funding 600–900, exec hire 300–500)
