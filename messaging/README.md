...
Brand messaging source of truth for social.plus. These files are fetched live from GitHub by the `brand-messaging` skill and other content skills in the [`marketing-team`](../marketing-team) plugin — edits here go live immediately, no reinstall needed.
