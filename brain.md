...
| Internal competitive briefings (competitor questions, battle cards, "how do we compare to X") | `marketing-team/skills/competitive-intelligence/SKILL.md` — internal-only output, no messaging brain needed |
...
| **competitive-intelligence** | Internal competitor briefings and Q&A — "brief me on competitors", "how do we compare to X", battle cards, competitor landscape. Reads private knowledge-layer Google Docs; internal-only output. | `marketing-team/skills/competitive-intelligence/SKILL.md` |
