...
|---|---|---|
| On the marketing team | `marketing-team` | Full kit — 18 skills covering content (blog, AEO, newsletters, case studies, press releases, brand voice), design system, SEO & internal linking, backlink work, site intelligence, competitive intelligence briefings, formatting utilities (legal docs, SVG icons), publishing (Google Docs → Webflow), and Webflow prototype migration. |
