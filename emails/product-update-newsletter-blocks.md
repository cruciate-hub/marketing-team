              ...
              <tr>
                <td class="mobile-stack mobile-center" width="50%" valign="top">
                  ...
                  <div style="padding-bottom:20px; font-size:0; line-height:0;">
                    <a href="https://www.linkedin.com/company/socialpluscorp/" target="_blank" style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#0A66C2; text-align:center; font-size:0; line-height:0; text-decoration:none; vertical-align:top; margin-right:8px;"><img src="https://cdn.jsdelivr.net/gh/gauravghongde/social-icons@master/PNG/White/LinkedIN_white.png" alt="LinkedIn" width="24" height="24" style="display:block; margin:10px auto; border:0;" /></a><a href="https://www.instagram.com/wearesocial.plus" target="_blank" style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#E4405F; text-align:center; font-size:0; line-height:0; text-decoration:none; vertical-align:top; margin-right:8px;"><img src="https://cdn.jsdelivr.net/gh/gauravghongde/social-icons@master/PNG/White/Instagram_white.png" alt="Instagram" width="24" height="24" style="display:block; margin:10px auto; border:0;" /></a><a href="https://x.com/socialpluscorp" target="_blank" style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#000000; text-align:center; font-size:0; line-height:0; text-decoration:none; vertical-align:top; margin-right:8px;"><img src="https://cdn.jsdelivr.net/gh/gauravghongde/social-icons@master/PNG/White/Twitter_white.png" alt="X" width="24" height="24" style="display:block; margin:10px auto; border:0;" /></a><a href="https://www.youtube.com/@wearesocialplus" target="_blank" style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#FF0000; text-align:center; font-size:0; line-height:0; text-decoration:none; vertical-align:top; margin-right:8px;"><img src="https://cdn.jsdelivr.net/gh/gauravghongde/social-icons@master/PNG/White/Youtube_white.png" alt="YouTube" width="24" height="24" style="display:block; margin:10px auto; border:0;" /></a><a href="https://github.com/Amityco" target="_blank" style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#24292F; text-align:center; font-size:0; line-height:0; text-decoration:none; vertical-align:top;"><img src="https://cdn.jsdelivr.net/gh/gauravghongde/social-icons@master/PNG/White/Github_white.png" alt="GitHub" width="24" height="24" style="display:block; margin:10px auto; border:0;" /></a>
                  </div>
                </td>
