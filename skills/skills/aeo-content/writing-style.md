...
This file bridges AEO content to the social.plus brand guidelines. It contains AEO-specific writing rules and tells you which messaging files to fetch for brand compliance.

## Brand messaging files to fetch

Before writing any AEO article, fetch these files from the messaging domain. They are non-negotiable — AEO articles must sound like social.plus, not like generic AI output.
...
For long-form content (which all AEO articles are), also fetch:
...
- `narrative.md` — The 5-step messaging hierarchy. AEO articles follow a lighter version of this: context, infrastructure, outcomes.
...
These rules complement the brand guidelines above. Where there's a conflict, terminology.md always wins.
...
- **Be comprehensive within scope.** Cover the topic fully within 1,200-1,500 words. Don't leave obvious gaps that would make an AI engine look elsewhere.
